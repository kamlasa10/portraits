...
/* harmony import */ var _modules_photoSize__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/photoSize */ "./src/js/modules/photoSize.js");
/* harmony import */ var _modules_tabs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/tabs */ "./src/js/modules/tabs.js");
/* harmony import */ var _modules_accordions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/accordions */ "./src/js/modules/accordions.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_photoSize__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_modules_accordions__WEBPACK_IMPORTED_MODULE_3__["default"])();
  ...
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_7__["default"])('input[name=phone]');
...
var accordions = function accordions() {
  var bindAccordion = function bindAccordion(triggerSelector, wrapAccoSelector, contentSelector, activeSelector, activeContentSelector) {
    var trigger = document.querySelectorAll(triggerSelector);
    var container = document.querySelector(wrapAccoSelector);
    var content = document.querySelectorAll(contentSelector);
    var activeTrigger = activeSelector.replace(/\./, '');
    var activeContent = activeContentSelector.replace(/\./, '');
    ...
    function hideAccordion() {
      trigger.forEach(function (item) {
        item.classList.remove("".concat(activeTrigger));
      });
      content.forEach(function (item) {
        item.style.display = 'none';
        item.classList.remove("".concat(activeContent), 'animate', 'fadeInDown');
      });
    }

    function showAccordion(idx) {
      trigger[idx].classList.add("".concat(activeTrigger));
      content[idx].style.display = 'block';
      content[idx].classList.add("".concat(activeContent), 'animate', 'fadeInDown');
    }
...
var calc = function calc(sizeSelector, materialSelector, optionsSelector, promocodeSelector, resultSelector) {
  ...
  var promoCode = document.querySelector(promocodeSelector);
  ...
  function calcData() {
    ...
    if (!size.value || !material.value) {
      ...
      total *= 0.7;
      result.textContent = "".concat(total, "\u0440\u0443\u0431");
    } else {
      result.textContent = "".concat(total, "\u0440\u0443\u0431");
    }
  }
...
var drop = function drop() {
  ...
  ['dragenter', 'dragleave', 'dragover', 'drop'].forEach(function (dragName) {
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./helpers */ "./src/js/modules/helpers.js");
/* harmony import */ var _calc__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./calc */ "./src/js/modules/calc.js");
...
var form = function form() {
  ...
  var photosFile = document.querySelectorAll('input[name=upload]');
  Object(_calc__WEBPACK_IMPORTED_MODULE_11__["default"])('#size', '#material', '#options', '.promocode', '.calc-price');
  photosFile.forEach(function (item) {
    item.addEventListener('input', function () {
      var sourse = item.files[0].name;
      var shortFileName = '';
      var dots = '';
  ...
  Object(_helpers__WEBPACK_IMPORTED_MODULE_10__["validateTextRu"])('input[name=name]');
  Object(_helpers__WEBPACK_IMPORTED_MODULE_10__["validateTextRu"])('input[name=message]');
  forms.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      serviceData(api, formData).then(function (res) {
        try {
          item.style.display = 'none';
...
var serviceData = function serviceData(url, data) {
...
/*!***********************************!*\
  !*** ./src/js/modules/helpers.js ***!
  \***********************************/
/*! exports provided: validateTextRu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "validateTextRu", function() { return validateTextRu; });
...
var validateTextRu = function validateTextRu(selector) {
...
var loadStyles = function loadStyles(triggerSelector, cards) {
  var content = document.querySelectorAll(cards);
...
var modals = function modals() {
  ...
  var bindModal = function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var mobileMenu = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
    var trigger = document.querySelectorAll(triggerSelector);
...
var photoSize = function photoSize() {
  var photosSizeBlocks = document.querySelectorAll('.sizes-block');
  var containerSize = document.querySelector('.sizes-wrapper');
  var photos = document.querySelectorAll('.sizes-block img');

  var bindPhoto = function bindPhoto(action) {
    containerSize.addEventListener(action, function (e) {
      var sizeStr = 'size-';
      var target = e.target;
      ...
      if (target.nodeName === 'IMG') {
        photos.forEach(function (item, i) {
          ...
          if (target.classList.contains("".concat(sizeStr).concat(i))) {
            target.src = "assets/img/sizes-".concat(i, "-1.png");
            target.style.zIndex = 1;
            target.style.position = 'relative';
            target.parentElement.classList.add('animated', 'fadeIn');

            if (action === 'mouseout') {
              target.src = "assets/img/sizes-".concat(i, ".png");
...
/* harmony default export */ __webpack_exports__["default"] = (photoSize);
  ...
  links.forEach(function (item) {
    item.addEventListener('click', function (e) {
      ...
      function step(time) {
        ...
        var r = toBlock < 0 ? Math.max(progress / speed, toBlock) : Math.min(progress / speed, toBlock);
...
var slider = function slider() {
  function bindSlider(dir, slidesSelector, prevSelector, nextSelector) {
    ...
    try {
      var _next = document.querySelector(prevSelector);

      var _prev = document.querySelector(nextSelector);
    ...
    showSlide(slideIndx);
    autoPlaySlide();
    slides[0].parentElement.addEventListener('mouseover', function () {
      clearInterval(pause);
    });
    slides[0].parentElement.addEventListener('mouseout', function () {
      autoPlaySlide(5000);
    });
  }
...
var tabs = function tabs() {
  var bindTabs = function bindTabs(headerTabsSelector, tabsSelector, contentTabsSelector, activeTabSelector, noPortfolio) {
    var containerTabs = document.querySelector(headerTabsSelector);
    var tabs = Array.from(document.querySelectorAll(tabsSelector));
    var content = Array.from(document.querySelectorAll(contentTabsSelector));
    var active = document.querySelector(activeTabSelector);
    var activeClassText = activeTabSelector.replace(/\./, '');
    var portfolioText = document.querySelector(noPortfolio);
    var filteredPhoto = [];
    ...
    function hideTabs() {
      ...
      filteredPhoto.forEach(function (item) {
    ...
    function showTabs(filterName) {
      ...
      filteredPhoto = content.filter(function (item) {
